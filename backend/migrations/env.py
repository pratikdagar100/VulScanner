"""Alembic environment for VulScanner.

The URL always comes from application settings so migrations and the running
application can never disagree about which database they are pointing at.
"""
